...
const carouselImages = [
  "/assets/home/carousel/building1.jpg",
  "/assets/home/carousel/building2.jpg",
  "/assets/home/carousel/building3.jpg",
  "/assets/home/carousel/building4.jpg",
  "/assets/home/carousel/building5.jpg",
  "/assets/home/carousel/building6.jpg",
];
...
export default function PrOverview() {
  return (
    <div
      id="about-section"
      className="my-4 font-montserrat flex w-full flex-col items-center justify-center p-4 2xl:px-16 3xl:px-22"
    >
